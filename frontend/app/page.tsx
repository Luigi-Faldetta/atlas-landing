            ...
            <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-10 shadow-xl border border-slate-200/60 dark:border-slate-700/60 overflow-hidden">
                ...
                <div className="relative group">
                  ...
                  <div className="relative p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 h-full">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Browse properties</h3>
                    </div>
                    <p className="text-slate-600 dark:text-slate-400">
                      Explore available properties with complete transparency on price, location, and income potential.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 h-full">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Invest your amount</h3>
                    </div>
                    <p className="text-slate-600 dark:text-slate-400">
                      Start with as little as €100 and purchase your share of a property.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative p-6 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 h-full">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Collect & grow</h3>
                    </div>
                    <p className="text-slate-600 dark:text-slate-400">
                      Receive your share of rental income monthly and watch your investment grow in value.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl text-center">
                <p className="text-slate-700 dark:text-slate-300">
                  Simple and straightforward. <span className="font-semibold text-blue-600 dark:text-blue-400">No hidden fees</span>, no surprises.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group bg-white dark:bg-slate-800 p-6 rounded-xl shadow hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-amber-200 dark:hover:border-amber-800 transform hover:-translate-y-1">
              <div className="flex items-start gap-4 mb-3">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">Straightforward Ownership</h3>
              </div>
              <p className="pl-14 text-slate-600 dark:text-slate-400">You legally own a piece of a real property.</p>
            </div>
            ...
            <div className="group bg-white dark:bg-slate-800 p-6 rounded-xl shadow hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-amber-200 dark:hover:border-amber-800 transform hover:-translate-y-1">
              <div className="flex items-start gap-4 mb-3">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">Monthly Income</h3>
              </div>
              <p className="pl-14 text-slate-600 dark:text-slate-400">You receive your share of the rental profits.</p>
            </div>
            ...
            <div className="group bg-white dark:bg-slate-800 p-6 rounded-xl shadow hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-amber-200 dark:hover:border-amber-800 transform hover:-translate-y-1">
              <div className="flex items-start gap-4 mb-3">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">Smart Ratings</h3>
              </div>
              <p className="pl-14 text-slate-600 dark:text-slate-400">We use Atlas, our AI-powered model to highlight strong properties, making your investment decisions easier.</p>
            </div>
            ...
            <div className="group bg-white dark:bg-slate-800 p-6 rounded-xl shadow hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-amber-200 dark:hover:border-amber-800 transform hover:-translate-y-1">
              <div className="flex items-start gap-4 mb-3">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">Fully Transparent</h3>
              </div>
              <p className="pl-14 text-slate-600 dark:text-slate-400">Property details, pricing, and income — always visible, never hidden.</p>
            </div>
            ...
            <div className="group bg-white dark:bg-slate-800 p-6 rounded-xl shadow hover:shadow-lg transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-amber-200 dark:hover:border-amber-800 transform hover:-translate-y-1">
              <div className="flex items-start gap-4 mb-3">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">No Management Needed</h3>
              </div>
              <p className="pl-14 text-slate-600 dark:text-slate-400">We handle the legal, admin, and maintenance. You just invest.</p>
            </div>
          </div>
        </div>
      </section>
