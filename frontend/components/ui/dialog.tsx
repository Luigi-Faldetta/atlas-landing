  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-5 top-5 rounded-full w-6 h-6 flex items-center justify-center text-blue-100 opacity-80 transition-opacity hover:opacity-100 focus:outline-none"
